...
public class State {
    ...
    public boolean isGoalState(int agentIndex) {
        ...
        // All boxes are on their goals and all agents are at their goals or not
        // blocking
        return true;
    }
    ...
    private boolean isApplicable(int agent, Action action) {
        ...
        switch (action.type) {
            ...
            // if(!(this.boxes[agentRow - 1][agentCol] >= 'A' && this.boxes[agentRow -
            // 1][agentCol] <= 'Z') &&
            // !(this.boxes[agentRow + 1][agentCol] >= 'A' && this.boxes[agentRow +
            // 1][agentCol] <= 'Z') &&
            // !(this.boxes[agentRow][agentCol - 1] >= 'A' && this.boxes[agentRow][agentCol
            // - 1] <= 'Z') &&
            // !(this.boxes[agentRow][agentCol + 1] >= 'A' && this.boxes[agentRow][agentCol
            // + 1] <= 'Z') ) {
            // return false;
            ...
            // if(this.walls[boxRow - action.boxRowDelta][boxCol - action.boxColDelta] ||
